...
export default function App() {
  ...
  const fetchEverything = async () => {
    let a = await fetch(
      "https://to-do-api-eta.vercel.app/api/task/view"
  ...
  const fetchOne= async (idd) => {
    ...
    setShowDetails(idd);
    let a = await fetch(
     `https://to-do-api-eta.vercel.app/api/task/view/${idd}`
  ...
  const handleAdd = async (e) => {
    ...
    if (index >= todos.length || index < 0) {
      let a = await fetch(
        ...
        "https://to-do-api-eta.vercel.app/api/task/insert"
        , {
        method: "POST",
        headers: {
      ...
      let a = await fetch(
       ...
       `https://to-do-api-eta.vercel.app/api/task/update/${idd}`
        , {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
    ...
    todos.map(async (item) => {
      if (item.idd == idd) {
        let a = await fetch(
         ...
         `https://to-do-api-eta.vercel.app/api/task/delete/${idd}`
          , {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
